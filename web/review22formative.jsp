<%-- 
    Document   : review22formative
    Created on : Nov 29, 2020, 1:11:52 AM
    Author     : User
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <%@include file= "Asset/Header.jsp"%>
                ...
                <% jdbcUtility = new JDBCUtility(driver,
                    ...
                    ResultSet rs = stmt.executeQuery("select * from formativeans2 where email='"+email+"' AND Id=(SELECT max(Id) FROM formativeans2 where email='"+email+"')");
                 %>
                 <!-- Answer Quiz-->
                <%  
                    int scoreF22 = 0;
                                ...
                                <table class="table table-bordered" id="prestasiTable" style="margin-left: auto; margin-right: auto; width: 80%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                Susunkan urutan Langkah- Langkah untuk melukis ERD untuk kenyataan "Murid mengambil Peperiksaan.<br>
                                                i.  Lukiskan simbol entiti dan hubungan yang mengaitkan kedua-dua entiti<br> 
                                                ii. Kenal pasti entiti: Murid, Peperiksaan<br>
                                                iii.Kenal pasti hubungan: mengambil
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Pilihkan kenyataan yang benar tentang entity teguh.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                            ...
                                            <td>
                                                Pilihkan kenyataan yg benar tentang Kebergantungan fungsi transitif.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Pilihkan skema hubungan yang berada dalam 1NF
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <h5 style="text-align: center" class="m-0 font-weight-bold text-primary text-center">
                                                    Markah anda adalah <% out.print(scoreF22); %> / 5
                                                </h5>
                                            </td>
                                        </tr>
                                    </tbody>

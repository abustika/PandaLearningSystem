<%-- 
    Document   : result_sumatif
    Created on : Dec 10, 2020, 6:50:50 PM
    Author     : aisrha
--%>
                ...
                <div class="container-fluid">
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold text-primary text-center">Penilaian Sumatif</h2>
                        </div>
                        <div class="card-body">
                            <h4 class="text-center"><strong>TAHNIAH!</h4><br><br>
                            <h5 class="text-center"><strong>Anda sudah menyelesaikan penilaian sumatif bagi topik 2.0 Pangkalan Data </strong></h5><br>
                            <h5 class="text-center"><strong>
                                                
                                                   
                                                   <% while (scoresum.next()){
                                                   String a = scoresum.getString("scoresumatif");
                                                   int scfsum = scoresum.getInt("scoresumatif");
                                                   scoresmtv = scfsum;
                                                   if(scoresmtv>=0 && scoresmtv<=2){
                            ...
                            <a class="btn btn-primary" href="reviewSumatif.jsp" role="button">Semak Jawapan</a>
                            </div>
                            <br>
                            <div class="text-center" >
                            <a class="btn btn-outline-primary" href="SummativeAttempt" role="button">Cuba Lagi</a>
                            </div> 

    ...
    <div id="wrapper">
        ...
        <%!
                ...
                <% jdbcUtility = new JDBCUtility(driver,
                  ...
                  ResultSet score4 = stmt4.executeQuery("select scoref24 from formativeans4 where Id=(SELECT max(Id) FROM formativeans4)");
                ...
                <div class="container-fluid">
                   <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="review24formative.jsp" role="button">Semak Jawapan</a>
                            </div>
                            <br>
                            <div class="text-center" >
                            <a class="btn btn-outline-primary" href="formative24attempt" role="button">Cuba Lagi</a>
                            </div> 

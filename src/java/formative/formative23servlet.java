...
@WebServlet(name = "formative23servlet", urlPatterns = {"/formative23servlet"})
public class formative23servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String res15 = "D. Semua di atas.";
         try{
            ...
            String sqlInsert = "INSERT INTO formativeans3(email, ques1, ques2, ques3, ques4, ques5, scoref23) VALUES (?,?,?,?,?,?,?)";
            ...
            response.sendRedirect (request.getContextPath() + "/result Formative 2.3.jsp");
    }

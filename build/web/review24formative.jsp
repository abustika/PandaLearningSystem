        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <%@include file= "Asset/Header.jsp"%>
                ...
                <% jdbcUtility = new JDBCUtility(driver,
                    ...
                    ResultSet rs = stmt.executeQuery("select * from formativeans4 where email='"+email+"' AND Id=(SELECT max(Id) FROM formativeans4 where email='"+email+"')");
                 %>
                 <!-- Answer Quiz-->
                <%  
                    int scoreF24 = 0; 
                                ...
                                <table class="table table-bordered" id="prestasiTable" style="margin-left: auto; margin-right: auto; width: 80%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                Susunkan fasa - fasa pembangunan pangkalan data untuk sistem maklumat.<br>
                                                i.  Mereka Bentuk<br> 
                                                ii.  Menyelenggara<br>
                                                iii. Membina<br>
                                                iv.  Merancang & Menganalisis
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Pangkalan data yang disimpan dalam komputer munggunakan aplikasi pangkalan data yang dinamakan ________.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Pernyataan ________ digunakan untuk mencapai data daripada jadual dalam pangkalan data.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                            ...
                                            <td>
                                                Yang berikut ialah tatacara pengesahsahihan data KECUALI.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Pernyataan _________ table dalam SQL digunakan untuk menghapuskan jadual daripada pangkalan data.
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: whitesmoke; text-align: center;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <h5 style="text-align: center" class="m-0 font-weight-bold text-primary text-center">
                                                    Markah anda adalah <% out.print(scoreF24); %> / 5
                                                </h5>
                                            </td>
                                        </tr>
                                    </tbody>

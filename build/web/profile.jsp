                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <br><img src="img/profileicon.png" alt="profileicon" style="width:20%;">
                          ...
                          <center>
                              <form action="editProfile.jsp" class="edit-form" id="edit-form"method="post"><br>
                                    <table>
                                        <tr>
                                            <td>Nama</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td><input type="text" id="name" name="name" value=" <%=resultSet.getString("name") %>" disabled></td>
                                        </tr>
                                        <tr><td><br></td></tr>
                                        <tr>
                                            <td>Jantina</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td><input type="text" id="gender" name="gender" value=" <%=resultSet.getString("gender") %>" disabled></td>
                                        </tr>
                                        <tr><td><br></td></tr>
                                        <tr>
                                            <td>E-mel</td>
                                        ...
                                        <tr>
                                            <td>Tarikh lahir</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td><input type="text" id="birthday" name="birthday" value=" <%=resultSet.getString("birthday") %>" disabled></td>
                                        </tr>
                                        <tr><td><br></td></tr>
                                        <tr>
                                            <td colspan="2"><center><a class="btn btn-outline-primary" href="index.jsp">Balik Halaman Utama</a></center></td>
                                            <td><center><input style="width: 90%;" class="btn btn-primary" type="submit" value="Mengedit"></center></td>
                                        </tr>
                                    </table>
                              </form><br>
                          </center>

                ...
                <!-- Begin Page Content -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 center">
                            <h2 class="m-0 font-weight-bold text-primary text-center">Nota Ringkas - Pembangunan Sistem Pangkalan Data</h2>
                        </div>
                        <div class="card-body">
                            <a href="Content Image/img_mind_map/2.4 mind map.png">
                            <img src="Content Image/img_mind_map/2.4 mind map.png" alt="" style="width:100%;height:100%;" class="container my-auto"/></a>
